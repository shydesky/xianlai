...
var GameLogic_HongHu147=function () {
    ...
    this.logic=function () {
        ...
        for(var roomId in rooms)
        {
            ...
            if(room.roomType!=RoomDefine.ROOM_TYPE_HONGHU_147)
            {
                continue;
            }
            ...
            case FlowDefine.HU_NO:
            {
                ...
                for(var uid in users) {
                    ...
                    if(uid==oper.uid)
                    {
                        ...
                        var dunShu=obj.tableScore+obj.huScore-10;
                        if(dunShu<0)
                        {
                            dunShu=0;
                        }
                       ...
                       // roomUser.score1+=dunShu;
                        ...
                        //天胡
                        if(huAction!=null&&huAction.type2==1)//0:,1:天胡,2:地胡,3:自摸胡,4:脱庄,5:闲加分
                        {
                            if(room.qita==0)
                            {
                              //  roomUser.score1+=1;
                        ...
                        if(room.qita==0)
                        {
                            ...
                            //朱胡
                            if(readCount==1)//0:,1:天胡,2:地胡,3:自摸胡,4:脱庄,5:闲加分6:朱胡。7:红胡,8:乌胡
                            {
                                huAction.type3.push(6);
                            ...
                            //红胡
                            if(readCount==4||readCount==7||readCount>=10)
                            {
                        ...
                        roomUser.dunshu=roomUser.dunshu*2;
    ...
    this.createGameFinishNotify=function (room,type,isGameOver) {
        ...
        for(var uid in users) {
           ...
           // userInfo.score=roomUser.score2/room.rule;
...
module.exports = GameLogic_HongHu147;
