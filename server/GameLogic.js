        ...
        for(var roomId in rooms)
        {
            ...
            switch(room.state)
            {
                ...
                case RoomDefine.ROOM_WAIT_ACK_STATE:
                {
                    ...
                    // var t_t=new Date().getTime()-room.waitAckTime;
                    // if(t_t>=20)
                    // {
        ...
        switch(flowNo)
        {
            ...
            case FlowDefine.START_NO:
            {
                ...
                if(RoomDefine.isTest2==1)
                {
                    ...
                    if(room.lastZhuangUid==null)
                    {
                        if(zhuangJiaUser==null)
                        {
                            ...
                            console.log("设定庄家:"+zhuangJiaUser.roomUser.type+","+u.name);

                            room.lastZhuangUid=u.uid;
                        }
                    }
                    else{
                ...
                if(RoomDefine.isTest2==1)
                {
                    ...
                    room.appendUserCard_test(1,1,4);
                    room.appendUserCard_test(1,1,4);
                    room.appendUserCard_test(1,1,4);
                    ...
                    room.appendUserCard_test(1,0,7);
                ...
                action_21.type=RoomDefine.ACTION_CARD_MOVE_TO_CARDS1;//0:发牌,1:提,2:跑,3:可吃,4:吃,5:可胡，6:胡，7:可碰,8:碰,9:等待出牌,10:出牌,11:隐藏选择按钮,12:取消超时等待
                ...
                if(zhuangJiaUser!=null)
                {
                    var action=zhuangJiaUser.roomUser.checkKeHu(null,true,RoomDefine.ROOM_TOUCH_CARD_TYPE);
                    if(action!=null)
                    {
               ...
               // console.log("userArr len:"+len);
                ...
                if(tableTopObj.count==1)
                {
                    ...
                    for(var i=0;i<len;i++) {
                        ...
                        var action=roomUser.checkKeHu(tableTopObj.card,isSelf,RoomDefine.ROOM_PUT_CARD_TYPE);
                    ...
                    if(tableTopObj.touchOrPut==RoomDefine.ROOM_TOUCH_CARD_TYPE)
                    {
                        ...
                        for(var i=0;i<len;i++) {
                            ...
                            var action=roomUser.checkKeHu(tableTopObj.card,isSelf,RoomDefine.ROOM_TOUCH_CARD_TYPE);
                ...
                if(!hasForceAction)//没有吃或者提的情况下 检查[碰/偎]
                {
            ...
            case FlowDefine.HU_NO:
            {
                ...
                for(var uid in users) {
                    ...
                    if(uid==oper.uid)
                    {
                        ...
                        roomUser.obj=obj;
                       // roomUser.score1+=obj.tableScore
                        //roomUser.score1+=obj.huScore;
                        ...
                        if(room.qita==1)
                        {
                            ...
                            if(readCount==0)//红字张数为0张(乌胡),  		则胡息为60胡(如果玩家胡息大于30胡,则按照实际胡息翻倍,比如胡息为35胡,则结算胡息为70胡)
                            {
                                huAction.type3.push(8);

                                if(roomUser.jiesuanHu<=30)
                                {
                                    roomUser.jiesuanHu=60;
                                }
                                else{
                                    roomUser.jiesuanHu*=2;
                                }
                        ...
                        //天胡
                        if(huAction!=null&&huAction.type2==1)//1:天胡,2:地胡,3:自摸胡
                        {

                            roomUser.jiesuanHu+=10;
                            console.log("[天胡加10胡息]");
                        }
                        ...
                        if(huAction!=null&&huAction.type2==3)//1:天胡,2:地胡,3:自摸胡
                        {
                            ...
                            console.log("[自摸胡加10胡息]");
                        }

                        roomUser.score1+=roomUser.jiesuanHu;

                        if(roomUser.score1>=100&&zhuangjiaUser!=null&&zhuangjiaUser.uid!=uid)
                        {
                            //牌局结束
                            gameOver=true;

                        }
                        else if(room.overUserId!=null)
                        {
                            if(room.overUserId!=uid)
                            {
                                //牌局结束
                                gameOver=true;
                          ...
                          //  console.log("[#1]");
                            ...
                            //检查是否满足百胡息
                            if(roomUser.score1>=100)
                            {
                                room.setGameOverUserId(uid);
                                console.log("[满百胡,设定游戏结束者]");
                            }
                            else{
                              //  console.log("[#2]");
                            }
                        ...
                        //roomUser.checkShouZhongHu(isSelf,room.tableTopObj.card);

                        // roomUser.score1+=roomUser.score2
                        // roomUser.score1+=roomUser.shouZhongScore;
              ...
              //  if(zhuangjiaUser!=null)
                {
                    ...
                    addScore=parseInt(huPaiUser.roomUser.jiesuanHu/2);
                    if(parseInt(huPaiUser.roomUser.jiesuanHu)%2!=0)
                    {
                        addScore+=1;
                    }


                    // if(zhuangjiaUser.uid==oper.uid)
                    // {
                    //
                    //
                    // }
                    ...
                    //if(zhuangjiaUser.roomUser.score1>subScore)
                   // {
                        zhuangjiaUser.roomUser.score1+=subScore;
                    // }
                    // else{
                    //     zhuangjiaUser.roomUser.score1=0;
                    // }

                    console.log("[庄家  "+subScore+"]");

                    if(zhuangjiaUser!=null)
                    {
                        zhuangjiaUser.roomUser.jiesuanHu+=subScore;
                    }


                    if(xianUser!=null)
                    {
                        xianUser.roomUser.score1+=addScore;
                        xianUser.roomUser.jiesuanHu+=addScore;

                        console.log("[闲家 + "+addScore+"]");
                    }


                }
                // else{
                //     console.log("[结算的时候庄家为null!!!!!]");
                // }
                ...
                for(var uid in users) {
                    ...
                    if (uid == oper.uid) {
                        ...
                        if(subScore<0&&zhuangjiaUser==user)
                        {
                            //脱庄
                            action.type2=4;//0:,1:天胡,2:地胡,3:自摸胡,4:脱庄,5:闲加分

                        }
                        else if(addScore>0&&roomUser.index==RoomDefine.XIANJIA_TYPE)
                        {
                            //闲加分
                            action.type2=5;//0:,1:天胡,2:地胡,3:自摸胡,4:脱庄,5:闲加分
